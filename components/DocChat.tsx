...
import { Send, FileText, Table, FileType, Loader2, Wand2, FormInput, MessageSquare, Bot, User, X, LogOut, ChevronDown, History as HistoryIcon, Plus, MessageCircle, Trash2 } from 'lucide-react';
...
const DocChat: React.FC<DocChatProps> = ({ onTransfer, onExit }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[75vh] max-w-7xl mx-auto bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in duration-500">
      
      {/* History Sidebar */}
      <div className="w-full lg:w-72 flex flex-col bg-gray-50 border-r border-gray-100 shrink-0">
          ...
          <div className="flex-grow flex flex-col min-w-0 border-r border-gray-100 bg-white relative">
            ...
            <div className="flex-grow relative overflow-hidden flex flex-col">
              ...
              <div 
                ...
                className="flex-grow overflow-y-auto p-6 space-y-6 custom-scrollbar bg-gray-50/20"
              >
                {messages.length === 0 && (
                      ...
                      {["Extract questions", "Draft a quiz", "Job application", "Customer survey"].map(item => (
                        <button 
                          ...
                          onClick={() => {
                            ...
                            // We don't auto-send here to let user edit or attach file
                          }}
